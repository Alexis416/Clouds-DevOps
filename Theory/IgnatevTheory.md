...
Итак, первое, что приходит в голову - это Yandex Cloud, его и будем рассматривать (всё же в России живём). Для отслеживания такой огромной инфраструктуры можно использовать специализированный сервис - Yandex Monitoring. Он автоматически собирает данные о состоянии ваших ресурсов в Yandex Cloud и отображает их на сервисных дашбордах.

#### Поставка метрик

Yandex Unified Agent — агент для поставки дополнительных метрик виртуальных машин и пользовательских приложений в сервисе Yandex Monitoring. Агент поддерживает: сбор системных метрик Linux (процессор, память, диск); поставку метрик в Yandex Monitoring; файловое хранилище для надежной доставки данных.
